    ...
    <div className="content">
      <div className="item">
        ...
        <p>
          ...
          python library. Then based on some rules and positions I detected
          entity and intents. I developed a technique to detect multi-word
          product names as an entity. I have also worked on detecting entities
          and intents from a speech. <br />
      ...
      <div className="item">
        ...
        <p>
          ...
          made Key Performance Indicator (KPI) dashboard in the pharma domain.
          Working on these dashboards has taught me about mining data from
          heterogeneous sources and use it as valuable information for business
          intelligence.
        </p>
        <ul className="tags">
      ...
      <div className="item">
        ...
        <p>
          I started my career as a software engineer at BRAC IT Limited. BRAC
          Bank is a well-recognized international bank, especially in south
          Asia. I have worked here in a project named ‘sbiCloud’ (Stitching BRAC
